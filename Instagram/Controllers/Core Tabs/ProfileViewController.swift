...
// Alonso: - ProfileInfoHeaderCollectionReusableViewDelegate
...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate {
    ...
    func profileHeaderDidTapFollowerButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        let vc = ListViewController(data: ["test","test"])
        vc.title = "Followers"
        vc.navigationItem.largeTitleDisplayMode = .never
        navigationController?.pushViewController(vc, animated: true)
    }
    ...
    func profileHeaderDidTapFollowingButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        let vc = ListViewController(data: ["Jose", "Juan","Pedro","Benito",])
        vc.title = "Following"
        vc.navigationItem.largeTitleDisplayMode = .never
        navigationController?.pushViewController(vc, animated: true)
...
extension ProfileViewController: ProfileTabsCollectionReusableViewDelegate{
    func didTapGridButton() {
        // Reload collection views with data
    }
